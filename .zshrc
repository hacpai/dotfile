...
plugins=(git zsh_reload colored-man colorize github jira vagrant virtualenv pip python brew brew-cask osx zsh-syntax-highlighting z command-not-found common-aliases git-prompt git-remote-branch gitignore osx profiles themes vi-mode)
